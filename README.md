...
1. Download **`jda-forge-1.0.2.jar`** from the [Releases](../../releases) page.
2. Put it in an empty folder and run it once — it generates the default files:
   ```bash
   java -jar jda-forge-1.0.2.jar
   ```
...
```bat
@echo off
java -Xms512M -Xmx2G -jar jda-forge-1.0.2.jar
pause
```
...
// build.gradle
dependencies {
    compileOnly 'com.github.drgnbld7:JDA-Forge:1.0.2'
